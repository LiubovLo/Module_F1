...
git clone https://github.com/LiubovLo/Module_F1.git cd weather-app
...
Select a city to view weather data. See current conditions and a 5-day forecast. View the city on a map.
